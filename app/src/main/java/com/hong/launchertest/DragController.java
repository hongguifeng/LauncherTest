...
public class DragController {
    ...
    public static final int RESCROLL_DELAY = 150;
    ...
    public DragView startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        final DragView dragView = mDragObject.dragView = new DragView(mLauncher, mDragLayer,
                b, registrationX, registrationY, 0, 0,
                b.getWidth(), b.getHeight(), initialDragViewScale);
...
//        Log.d(TAG, "checkTouchMove: " + dropTarget);
        if (dropTarget != null) {
            if (mLastDropTarget != dropTarget) {
//                Log.d(TAG, "checkTouchMove: ");
                if (mLastDropTarget != null) {
                    mLastDropTarget.onDragExit(mDragObject);
                }
