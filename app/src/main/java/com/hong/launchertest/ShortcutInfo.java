...
//     */
    ...
    ShortcutInfo() {
        itemType = 1;//LauncherSettings.BaseLauncherColumns.ITEM_TYPE_SHORTCUT;
    }
...
//        if (itemType == 0){//Favorites.ITEM_TYPE_APPLICATION) {
...
//    }
    ...
    public boolean shouldUseLowResIcon() {
        return usingLowResIcon && container >= 0 && rank >= 3; //FolderIcon.NUM_ITEMS_IN_PREVIEW;
    }
